...
DATA_DIR = BASE_DIR / "sample_100_fixed" / "sample_100_plt_rich"
...
def main() -> None:
    ...
    parser.add_argument("--data-dir", type=str, default=str(BASE_DIR / "sample_100_fixed" / "sample_100_plt_rich"), help="Path to data directory")
